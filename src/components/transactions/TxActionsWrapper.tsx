...
export const TxActionsWrapper = ({
  ...
  function getMainParams() {
    ...
    if (isConnectNetWorkTon && isAmountMissing)
      return { disabled: true, content: <Trans>Enter an amount</Trans> };
    if (isConnectNetWorkTon && preparingTransactions) return { disabled: true, loading: true };
    if (isConnectNetWorkTon && !mainTxState?.loading)
