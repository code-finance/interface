...
export const FACTORY_DEDUST =
  process.env.NEXT_PUBLIC_FACTORY_DEDUST_TESTNET ||
  'EQAROb_l-1yGMKjPGUmc0tNjYOsXTKTsucXmhh2Fm9y98z7Y';
export const address_pools =
  process.env.NEXT_PUBLIC_ADDRESS_POOL_TESTNET ||
  'EQBvPQOrx9jZ6--_hlswjUAsAKjwlJoaO5p_oKQZ5S2NiE5I';
export const MAX_ATTEMPTS = 100;
export const MAX_ATTEMPTS_50 = 50;
export const GAS_FEE_TON = 0.3;
export const API_TON_V2 =
  process.env.NEXT_PUBLIC_API_TON_V2_TESTNET || 'https://testnet.toncenter.com/api/v2';
export const API_TON_V3 =
  process.env.NEXT_PUBLIC_API_TON_V3_TESTNET || 'https://testnet.toncenter.com/api/v3';
export const API_TON_SCAN_V2 =
  process.env.NEXT_PUBLIC_API_TON_SCAN_V2_TESTNET || 'https://testnet.tonapi.io/v2';
export const SCAN_TRANSACTION_TON =
  process.env.NEXT_PUBLIC_SCAN_TRANSACTION_TON_TESTNET || 'https://testnet.tonviewer.com';
export const URL_API_BE =
  process.env.NEXT_PUBLIC_URL_API_BE || 'https://aave-ton-api.sotatek.works';
export const SCAN_PRICE_TON = process.env.NEXT_PUBLIC_SCAN_PRICE_TON || 'https://www.coingecko.com';
export const URL_PUBLIC =
  process.env.NEXT_PUBLIC_URL_PUBLIC || 'https://aave-stesting.sotatek.works';
